...
sealed class ValidationFormEvent {
    ...
    data class PrePaymentPercentChanged(val prepaymentPercent: String) : ValidationFormEvent()
    data class PricePerDayChanged(val pricePerDay: String) : ValidationFormEvent()
    data class PledgeChanged(val pledge: String) : ValidationFormEvent()
    ...
    data class CompletedPledgeChanged(val completedPledge: String) : ValidationFormEvent()
